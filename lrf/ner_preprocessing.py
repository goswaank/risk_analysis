...
from lrf import lrf_config, utility,constants
import os
import re
...
def vectorize_unique_words(data):
    ...
    for word in unique_words:
        word_len = len(word)
        initialized_word_matrix = np.random.uniform(low=lower_lim,high=upper_lim,size=(constants.CHAR_EMBED_DIM,word_len))
